...
```{include} ../../../README.md
:start-after: <!-- docs:getting-started-quickstart-cli:start -->
:end-before: <!-- docs:getting-started-quickstart-cli:end -->
```

## Python API

```{include} ../../../README.md
:start-after: <!-- docs:getting-started-quickstart-python:start -->
:end-before: <!-- docs:getting-started-quickstart-python:end -->
```
