"""
:mod:`tests.unit.file.pytest_file_contract_category_mixins` module.

Category-specific contract mixins used by
:mod:`tests.unit.file.pytest_file_contract_contracts`.
"""
