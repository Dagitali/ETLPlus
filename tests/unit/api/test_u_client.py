...
class TestCursorPagination:
    ...
    def test_page_size_normalizes(
        ...
        monkeypatch.setattr(rmod.RequestManager, '_request_once', fake_request)
    ...
    def test_error_includes_page_number(
        ...
        monkeypatch.setattr(rmod.RequestManager, '_request_once', extractor)
...
class TestErrors:
    ...
    def test_auth_error_wrapping_on_single_attempt(
        ...
        monkeypatch.setattr(rmod.RequestManager, '_request_once', boom)
